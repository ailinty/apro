...
public class TelephoneWriteUserReplyPacket extends InPacket{

	
	public TelephoneWriteUserReplyPacket(char command, String message) throws PacketParseException{
