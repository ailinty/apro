...
public class PT2262433StudyOKReplyPacket extends SensorStudyOKReplyPacket{

	public PT2262433StudyOKReplyPacket(char command, String message) throws PacketParseException{
		super(command, message);
	}
	
	@Override
	protected void parseBody() throws PacketParseException {
		String body = message.substring(Protocol.MSG_PT2262_433M_STUDY_OK_REPLY.length());
