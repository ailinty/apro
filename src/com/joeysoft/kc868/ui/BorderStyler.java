...
public class BorderStyler implements IBorderControlProvider {
	...
	public Composite decorateShell(Shell s) {
		...
		if(showMaxButton) {
			...
			lblMax.addMouseTrackListener(new MouseTrackAdapter() {
				...
				public void mouseEnter(MouseEvent e) {
					Label lbl = (Label)e.getSource();
					lbl.setImage(shell.getMaximized() ? icons.getImage(IconHolder.bmpRestoreHover) : icons.getImage(IconHolder.bmpMaxHover));
				}
				
				@Override
				public void mouseExit(MouseEvent e) {
					Label lbl = (Label)e.getSource();
					lbl.setImage(shell.getMaximized() ? icons.getImage(IconHolder.bmpRestoreNormal) : icons.getImage(IconHolder.bmpMaxNormal));
				}
			});
			lblMax.addMouseListener(new MouseAdapter() {
				...
				public void mouseDown(MouseEvent e) {
					Label lbl = (Label)e.getSource();
					lbl.setImage(shell.getMaximized() ? icons.getImage(IconHolder.bmpRestoreDown) : icons.getImage(IconHolder.bmpMaxDown));
				}
	...
	protected void doMaximize() {
		...
		lblMax.setImage(shell.getMaximized() ? icons.getImage(IconHolder.bmpRestoreHover) : icons.getImage(IconHolder.bmpMaxHover));
	}
