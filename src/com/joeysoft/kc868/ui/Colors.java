...
public class Colors {
    ...
    public static void init() {
        ...
        MAINSHELL_BORDER_OUTMOST = new Color(display, 0x1E, 0x3E, 0x93);
        ...
        LOGIN_BACKGROUND = new Color(display, 0x08, 0x76, 0xDD);
        
        GLOBAL_FONT = new Font(display, "宋体", 12, SWT.BOLD);
        
        GL_FONT = new Font(display, "宋体", 10, SWT.NONE);
        
        NORMAL_FONT = new Font(display, "宋体", 16, SWT.BOLD);
        
        LOADING_FONT = new Font(display, "宋体", 24, SWT.BOLD);
        
        TITLE_FONT = new Font(display, "宋体", 30, SWT.BOLD);
    }
