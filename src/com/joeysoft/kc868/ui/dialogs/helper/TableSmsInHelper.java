...
public final class TableSmsInHelper {
	 ...
	 * 刷新Table
	 */
	public void showTable(Table table, List<SmsIn> list){
		table.removeAll();
		for(SmsIn smsIn : list){
			insertTable(table, smsIn);
		}
	}
	 ...
	 * @param floor
	 */
	public void updateTable(Table table, SmsIn smsIn){
		if(smsIn != null){
