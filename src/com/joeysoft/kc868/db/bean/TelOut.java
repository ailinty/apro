...
public class TelOut {
	...
	public TelOut(String telId, String telPhone, String telName, String countryCode) {
		super();
		this.telId = telId;
	...
	public TelOut(String telId, String telPhone, String telName, String countryCode, Integer telIndex) {
		super();
		this.telId = telId;
		this.telPhone = telPhone;
		this.telName = telName;
